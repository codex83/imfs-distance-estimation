#!/usr/bin/env python3
"""
CLI script for training the lightweight model.
"""
...
from src.training import train_lightweight_model


def main():
    parser = argparse.ArgumentParser(description='Train lightweight model')
    ...
    # Train model
    history = train_lightweight_model(
